...
if current_platform.is_cuda():
    from fastdeploy.worker.vl_gpu_model_runner import GPUVLModelRunner as VLModelRunner
elif current_platform.is_xpu():
    from fastdeploy.worker.vl_xpu_model_runner import XPUVLModelRunner as VLModelRunner
